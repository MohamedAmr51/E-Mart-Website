   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><a href="index.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('Remove product from cart?    ');">Remove product</a></td>
         </tr>
      <?php
...
<center>
   <a href="address.php">Enter your address</a>
</center>
